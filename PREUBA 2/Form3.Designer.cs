namespace PREUBA_2
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            button5.ForeColor = Color.FromArgb(0, 116, 204);
            button5.Location = new Point(0, 504);
            button5.Name = "button5";
            button5.Size = new Size(320, 72);
            button5.TabIndex = 18;
            button5.Text = "NUEVO REPORTE";
            ...
            button7.Location = new Point(0, 648);
            ...
            button8.Location = new Point(0, 720);
